...
- (Don't git clone)
- Run this: `setup_or_copy=setup eval "$(curl -fsSL git@github.com:jeff-hykin/better-snippet-syntax.git || wget -qO- git@github.com:jeff-hykin/better-snippet-syntax.git)"`
...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`eval "$(curl -fsSL git@github.com:jeff-hykin/better-snippet-syntax.git || wget -qO- git@github.com:jeff-hykin/better-snippet-syntax.git)"`<br>[press enter]
    - Possible errors:
